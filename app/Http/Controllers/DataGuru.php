...
class DataGuru extends Controller
{
    ...
    public function create()
    {
        ...
        $guru =Guru::join('jenjang_pendidikan', 'jenjang_pendidikan.jp_id = guru.jp_id')->where('jenjang_pendidikan_detail');
  ...
  public function show($id)
    {
        ...
        return view('showguru', compact('model'));
    }

// public function show(Request $request,$id)
//     {
//         $guru = Guru::find($id);
//         return view('guru.show',compact('title','guru','jenjang_pendidikan'))->renderSections()['content'];
//     }
